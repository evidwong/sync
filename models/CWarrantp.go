...
type CWarrantp struct {
	...
	CWarrantCode   string          `gorm:"column:CWarrantCode;primary_key" json:"CWarrantCode;primary_key"`
	...
	WRejectAmount  sql.NullFloat64 `gorm:"column:WRejectAmount" json:"WRejectAmount"`
...
func (c *CWarrantp) TableName() string {
	return "c_warrantp"
}
