...
type CarBak struct {
	...
	CarModel          int    `gorm:"column:car_model" json:"car_model"`
	...
	Surplus           string `gorm:"column:surplus" json:"surplus"`
	Travel            string `gorm:"column:travel" json:"travel"`
...
func (c *CarBak) TableName() string {
	return "car_bak"
}
